...
if (!defined('ft_btn_edit')) {
    ...
    define('ft_error_detail_params_missing', '<p>Mit dem Droplet <b>flex_detail</b> wurden keine gültigen Parameter übergeben!</p>');
    define('ft_error_preset_not_exists', '<p>Das Preset <b>%s</b> existiert nicht!</p>');
    define('ft_error_row_id_invalid', '<p>Die Zeilen ID <b>%05d</b> ist ungültig!</p>');
    ...
    define('ft_error_table_name_invalid', '<p>Der Tabellen Bezeichner <b>%s</b> ist ungültig!</p>');
    ...
    define('ft_intro_rows_list', 'Um die Inhalte eines Eintrag zu ändern klicken Sie auf <b>Edit</b>, um eine Zeile zu löschen entfernen Sie das Häkchen in der Spalte <b>Active</b>.</p><p>Um die Inhalte einer Zeile (auch die nicht in der Tabelle angezeigten) in eine neue Zeile zu kopieren, setzen Sie ein Häkchen bei <b>Copy</b> und klicken Sie anschließend auf <b>Übernehmen</b>.</p>');
