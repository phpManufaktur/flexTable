...
define('ft_hint_ftd_name',											'Der Bezeichner muss eindeutig sein und wird für die Identifizierung der Felder und für das automatische Setzen von CSS Klassen verwendet.');
...
define('ft_intro_row_add',											'Fügen Sie der Tabelle einen weiteren Eintrag hinzu, in dem Sie die folgenden Felder ausfüllen und auf <i>Übernehmen</i> klicken.<br /><b>Wichtig:</b> Das erste Feld darf nicht leer sein, sonst wird der Datensatz nicht übernommen.');
