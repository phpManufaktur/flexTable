...
if (!defined('ft_btn_edit')) {
    ...
    define('ft_error_detail_params_missing', '<p>Invalid params for the Droplet <b>flex_detail</b>!</p>');
    define('ft_error_preset_not_exists', '<p>The preset <b>%s</b> doesnt exist!</p>');
    define('ft_error_row_id_invalid', '<p>The Row ID <b>%05d</b> is invalid!</p>');
    ...
    define('ft_error_table_name_invalid', '<p>The table name <b>%s</b> is invalid!</p>');
